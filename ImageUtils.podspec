#
#  Be sure to run `pod spec lint ImageUtils.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = fmwk_name
  s.version      = '0.0.1'
  s.summary      = 'An elegant image utils & toolbox framework in pure Swift.'
  ...
  # Or just: s.author    = "0xxd0"
  # s.authors            = { "0xxd0" => "10173746+0xxd0@users.noreply.github.com" }
  # s.social_media_url   = "http://twitter.com/0xxd0"
